...
|----------------|----------|---------------|
| **4.0 - 4.4** | [SmilePnP_v0.1_Blender4.zip](https://github.com/votre-username/SmilePnP/releases/download/v0.1.0/SmilePnP_v0.1_Blender4.zip) | [Installation Guide](docs/installation.md) |
| **5.0+** | [SmilePnP_v0.1_Blender5.zip](https://github.com/votre-username/SmilePnP/releases/download/v0.1.0/SmilePnP_v0.1_Blender5.zip) | [Installation Guide](docs/installation.md) |
